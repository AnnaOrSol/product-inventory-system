...
import {
    updateInventoryItem,
    deleteInventoryItem,
    type DeleteInventoryItemReason,
...
export function InventoryCard({ item, onUpdate, onDeleted }: InventoryCardProps) {
    ...
    const handleConfirmDelete = async ({
        ...
        try {
            ...
            await deleteInventoryItem(item.id, { reason, details });
            ...
            >
                <CardContent className="p-3 sm:p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between gap-2">
                        ...
                        <div className="flex shrink-0 items-center gap-1 opacity-100 transition-opacity">
                            <Button
                                variant="ghost"
                                size="icon"
                            ...
                            <Button
                                ...
                                className="h-8 w-8 rounded-xl text-muted-foreground hover:bg-muted hover:text-destructive"
                            >
